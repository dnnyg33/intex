...
public class SetCommissionsScheduleDialog extends Dialog {
	...
	private CommissionsWindow parent;
	 ...
	 * @param style
	 */
	public SetCommissionsScheduleDialog(Shell parent, int style, CommissionsWindow window) {
		super(parent, style);
		this.parent=window;
		setText("Start Time");
	}
	...
	private void createContents() {
		...
		btnOk.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				parent.setHour(Integer.valueOf(hourSpinner.getText()));
				System.out.println("setGeneralLedgerDIalog after parent.setHour");
				System.out.println(parent.hour);
				parent.setMinute(Integer.valueOf(minSpinner.getText()));
				parent.setAmpm(ampm);
				shell.close();
